...
| Манифест плагина | `.claude-plugin/plugin.json` | Имя плагина, `version` (`0.6.0`), ключевые слова — читается загрузчиком плагинов Claude Code |
