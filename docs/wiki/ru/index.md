...
|--------|--------|----------|
| [Модули](modules/) | 16 | Python-скрипты пересборки всех генерируемых артефактов плюс установщик Codex, синхронизация чисел в доках и хук-гейт вики |
...
Шестнадцать Python-скриптов, организующих конвейер пересборки, семантический поиск во время выполнения и установку Codex-плагина.
...
- [test_update_changelog](modules/test_update_changelog.md) — регрессионные тесты changelog-хука
