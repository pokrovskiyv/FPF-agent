...
It has two halves: an automatic half (a PreToolUse hook that runs on every commit) and a manual half (a human-written "What's New" section). The current published version is **0.10.0**.
