...
- **Full chain adds:** `C.2.LS` (U.LanguageStateFacetProfile — thin profile bundle for language state), `A.16.2` (Reopen / SketchBackoff / Respecify), `B.4.1` (Observe → Notice → Stabilize → Route), `B.5.2.0` (U.AbductivePrompt).
...
| 2 | C.2.LS | U.LanguageStateFacetProfile — thin profile bundle for language state | |
