...
За кулисами работает [FPF](https://github.com/ailev/FPF) (First Principles Framework), спецификация на 59 000 строк с паттернами координации. В выводе вы этого не увидите: ни терминологии, ни идентификаторов паттернов.

Как устроен процесс:
1. Описываете задачу обычным языком
2. Система определяет, какие паттерны применимы
3. Получаете структурированный результат в тех же терминах, что использовали
