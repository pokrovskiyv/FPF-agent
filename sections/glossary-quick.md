...
| CG-Spec | G.0 | Set design-time rules for which comparisons are lawful in a given frame. |
...
| action | A.2.2 | Describe what a system can do, within declared limits and evidence. |
...
| recipe | A.3.1 | Capture the abstract steps of a task separately from any single run. |
| specification | A.3.2 | Document a method fully enough to plan, review, or audit its execution. |
